...
$wgEmergencyContact = "d.fichtmueller@bgbm.org";
$wgPasswordSender = "noreply@modelling.dissco.tech";
...
#$smtp_host, $smtp_username and $smtp_password are included in the file email_credentials.php which is not committed to the repository



# fix issue that Docker proxy IP is shown as user IP
$wgUseCdn = true;
$wgCdnServers = array();
$wgCdnServers[] = "172.23.0.11";
